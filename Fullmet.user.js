...
(function() {
    ...
    honami_FullmetInlineStyle += ".uAzxg{bottom: 1rem; padding: 1rem 0; height: unset; top: unset;}";  // participant tooltip
    var honami_FullmetClassDelay = 2000;

    // internal variables
    var honamiInternals_debug_enabled = true;
    ...
    function honami_videoNode_injectClass(){
        ...
        if(videoNode){
            for(var i = 0; i < videoNode.length; i++){
                videoNode[i].setAttribute('controls', '');
            };
        }
